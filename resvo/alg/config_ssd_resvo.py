...
def get_config():
    ...
    config.lio.svo = True
    config.lio.svo_ego = True
    config.lio.low_rank = 3
    config.lio.r_ego_multiplier = 1.0
    config.lio.activate_r = 0.0

    config.main = ConfigDict()
    config.main.dir_name = 'small_n2_resvo'
